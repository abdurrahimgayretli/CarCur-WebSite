...
window.onload = function () {
  ...
  <td class="iki0">
    <img id="photo" width="145" height="145" src="" />
  </td>
  ...
  <td class="toplam0">
    ...
    for (var key in obj.products) {
      if (
        params.replaceAll(" ", "") == obj.products[key].name.replaceAll(" ", "")
      ) {
        document.getElementById("photo").src = obj.products[key].photo;
        document.getElementById("price").innerText = obj.products[key].price;
        document.getElementById("name").innerText = obj.products[key].name;
        document.getElementById("subTotal").innerText =
          parseFloat(obj.products[key].price) *
