...
window.onload = function () {
  ...
  Object.entries(listCategory).forEach((i) => {
    const [key, value] = i;
    if (data.replaceAll(" ", "") == key.replaceAll(" ", "")) {
      index = value;
  ...
  list1.forEach((product, i) => {
    ...
    <div class="block">
                    ...
                    <div class="bilgi">
                        ...
                        <a class="satin-al_s" onclick="getProduct('${product}');">Satın Al</a>
                    </div>
    </div>
        
    `;
    document.getElementById(product).innerHTML = obj.products[i + index].name;
    document.getElementById(product + "price").innerHTML =
      obj.products[i + index].price;
    document.getElementById(product + "photo").src =
      obj.products[i + index].photo;
  });
  list2.forEach((product, i) => {
    ...
    document.getElementById(product).innerHTML =
      obj.products[i + index + 4].name;
    document.getElementById(product + "price").innerHTML =
      obj.products[i + index + 4].price;
    document.getElementById(product + "photo").src =
      obj.products[i + index + 4].photo;
  });
};
